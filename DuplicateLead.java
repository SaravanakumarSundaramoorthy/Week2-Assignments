...
public class DuplicateLead {
	...
	String resultofpage1=driver.getTitle();
	System.out.println("The Title is "+ resultofpage1);
	...
	driver.findElement(By.id("createLeadForm_firstName")).sendKeys("SARAVANAKUMAR");
	driver.findElement(By.name("submitButton")).click();
	String resultofpage2=driver.getTitle();
	System.out.println("The Title is "+ resultofpage2);
}
}
